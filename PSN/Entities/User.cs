...
namespace PlayStationSharp.API
{
	public class User : AbstractUser
	{
		...
		public bool AddFriend(RequestType requestType = RequestType.Normal, string requestMessage = "")
		{
			...
			{
				var endpoint =
					$"{EndPoints.USERS_URL}{this.Client.Account.OnlineId}/friendList/{this.Profile.OnlineId}{(requestType == RequestType.Close ? "/personalDetailSharingWithBody" : "")}";
		...
		public void RemoveFriend()
		{
			try
			{
				Request.SendDeleteRequest<object>(
					$"{EndPoints.USERS_URL}{this.Client.Account.OnlineId}/friendList/{this.Profile.OnlineId}",
		...
		public void Block()
		{
			var response = Request.SendJsonPostRequestAsync<object>($"{EndPoints.USERS_URL}{this.Client.Account.OnlineId}/blockList/{this.Profile.OnlineId}",
		...
		public void Unblock()
		{
			var response = Request.SendDeleteRequest<object>($"{EndPoints.USERS_URL}{this.Client.Account.OnlineId}/blockList/{this.Profile.OnlineId}",
				this.Client.Tokens.Authorization);
		}
